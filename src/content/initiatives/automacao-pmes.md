---
title:
  en: Process Automation and Digitization for Small Businesses
  pt: Automação e Digitalização de Processos para PMEs
shortTitle: { en: Automation for Small Businesses, pt: Automação para PMEs }
summary:
  en: A portfolio of small automation and digitization projects for partner organizations, keeping client identities private when appropriate.
  pt: Um portfólio de pequenos projetos de automação e digitalização para organizações parceiras, preservando a identidade dos clientes quando apropriado.
kind: consulting
kindLabel: { en: Consulting · Extension, pt: Consultoria · Extensão }
status: open
statusLabel: { en: Two concrete needs identified, pt: Duas demandas concretas identificadas }
areas: [innovation-transfer]
people: []
defined:
  en:
    - One workstream concerns daily operational automation for a timber business.
    - A second workstream concerns an interactive form for a consulting company.
  pt:
...
participation:
  ...
  pt: [Consultoria, Extensão, Projeto aplicado]
order: 8
---
