---
title: { en: AgroHub — Agricultural Marketplace, pt: AgroHub — Marketplace Agrícola }
shortTitle: { en: AgroHub, pt: AgroHub }
summary:
  en: An existing agricultural marketplace with catalogs, offers, proposals, and workflows for multiple user profiles.
  pt: Um marketplace agrícola existente com catálogos, ofertas, propostas e fluxos para diferentes perfis de usuário.
kind: product
...
defined:
  en:
    - The platform uses a monorepo with a React and Next.js frontend and a Node.js backend.
    - Known flows include sign-in, catalog browsing, product CRUD, proposal review, and offers.
    - Existing roles include administrator, client, sales attendant, and sales representative.
  pt:
    - A plataforma usa um monorepo com frontend React e Next.js e backend Node.js.
...
participation:
  ...
  pt: [Engenharia voluntária, Trabalho em produto, Projeto aplicado]
order: 6
---
